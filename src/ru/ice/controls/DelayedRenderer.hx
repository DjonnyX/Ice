...
{
	public static inline var DEFAULT_DELAYED_RENDERER_STYLE:String = 'default-delayed-renderer-style';
	...
	public function new(owner:BaseIceObject, content:DisplayObject) {
		_owner = owner;
		_content = content;
		styleName = DEFAULT_DELAYED_RENDERER_STYLE;
	}
	...
	public function add(factory:Function) : Void {
