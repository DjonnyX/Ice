...
{
	public static inline var DEFAULT_STYLE:String = 'default-contacts-screen-style';
	...
	public function new() 
	{
		super(new ElementData({'name':'Contacts'}));
	}
	...
	override public function initialize():Void 
	{
		...
		if (data != null) {
			var items:Array<FlickerControl> = Flicker.serializer.serialize(data.content);
			for (item in items) {
