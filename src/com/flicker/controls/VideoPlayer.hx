...
class VideoPlayer extends FlickerControl
{
	...
	private var _controlPanel:FlickerControl;
	...
	public function new(?elementData:ElementData) 
	{
		...
		super(elementData);
		_videoContainer = new FlickerControl(new ElementData({name:'vpc'}));
